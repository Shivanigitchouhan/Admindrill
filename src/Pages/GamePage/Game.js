...
//for static contest list functionality
function RenderRow() {
  ...
  return (
    <Box sx={{ display: "flex" }}>
      ...
      <Box component="main" className={classes.box3}>
        ...
        <Typography variant="h6" gutterBottom className={classes.gameType}>
          All Contest
        </Typography>
            ...
            <Card className={classes.card}>
              <Box component="main" className={classes.box5}>
                ...
                <Button
                  ...
                  sx={{ color: activePoint ? "#7569F1" : "#7569F1" }}
                >
                  Contest{" "}
                </Button>
                <Button
                ...
                <Button
                  ...
                  sx={{ color: activeTeamOne ? "#7569F1" : "black" }}
                >
                  Games
                </Button>
                {/* <Button onClick={handleTeamTwo} className={classes.teamBoth} sx={{ color: activeTeamTwo ? "#7569F1" : "black", }}>xyz</Button> */}
                <Button
                  onClick={handleTime}
                  className={classes.teamBoth}
                                            ...
                                            <div>
                                                ...
                                                >
                                                    <Box className={classes.text1}>
                                                        <Typography  >{dataById.name}</Typography>
                                                        <Box sx={{ ml: 14, mt: -5 }}><img width='75px' height='65px' src={sign} /></Box>
                                                    </Box>

                                                    <Box sx={{ ml: 18 }}>
                                                        <Typography className={classes.text2} >Live</Typography>
                                                        <Typography className={classes.text3} variant='caption'>5CR Prize Money</Typography>
                                                        <Typography className={classes.text4} variant='subtitle2'>{dataById.total_players} people are playing</Typography>
                                                        <Box sx={{ ml: 25, mt: -8 }}>
                                                            <img width='65px' height='65px' src={clip} />
                                                            <Typography sx={{ mt: -6, ml: 15 }}>Super Stars</Typography>
                                                        </Box>
                                                    </Box>
                                                    <Box sx={{ ml: 5 }}>
                                                                ...
                                                                <>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <Box sx={{ ml: 18 }}>
                                                                            <Typography className={classes.text2} >Live</Typography>
                                                                            <Typography className={classes.text3} variant='caption'>5CR Prize Money</Typography>
                                                                            <Typography className={classes.text4} variant='subtitle2'>{res.total_players} people are playing</Typography>
                                                                            <Box sx={{ ml: 25, mt: -8 }}>
                                                                                <img width='65px' height='65px' src={clip} />
                                                                                <Typography sx={{ mt: -6, ml: 15 }}>Super Stars</Typography>
                                                                            </Box>
