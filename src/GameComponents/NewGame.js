...
import NewGameCSS from "../assets/styles/GameStyle/NewGame.style";
...
//for newgame style
const useStyles = makeStyles(NewGameCSS);
...
export default function NewGame(props) {
  ...
  const handleNext = () => {
    ...
    axios
      .post("http://192.168.1.60:4000/gameType/addGameType", data)
      .then((res) => {
        console.log(100, res);
        if (res.status === 200) {
        }
              ...
              >
                ...
                <MenuItem>
                  <TextField
                    ...
                    sx={{ width: "50%" }}
                    id="standard-basic"
                    label="Enter total_players"
                    type="number"
                    variant="standard"
                  />
                  <SportsHandballIcon sx={{ ml: "-3%" }} />
                </MenuItem>
                <MenuItem>
                  <Button
                    onClick={handleNext}
